...
class Organism {
    public:
        ...
        bool leagalPositionOrg(int xCord, int yCord);
    
        int getBreed();
    
        void setBreedToZero();
    
        void setBreedNextTime(bool Xor);
    
        bool getBreedNextTime();
    ...
    protected:
        ...
        //geymir hvort tad a ad breeda i naestu umferd
        bool breedNextTime;
    
        void actualMove(int inputX, int inputY);
